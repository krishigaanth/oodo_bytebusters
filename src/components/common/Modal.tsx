...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        ref={modalRef}
        className={`relative w-full ${maxWidthStyles[maxWidth]} rounded-3xl bg-white shadow-2xl border border-slate-200/80 overflow-hidden z-10 animate-fade-in my-auto flex flex-col max-h-[90vh]`}
      >
        {/* Header */}
